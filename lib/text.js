...
var AXIS = [0,0,0]
proto.drawTicks = function(d, scale, angle, offset, color, direction) {
  if(!this.tickCount[d]) {
    return
  }
  ...
  this.shader.uniforms.direction = direction
  this.vao.draw(this.gl.TRIANGLES, this.tickCount[d], this.tickOffset[d])
}

//Draws the text label for an axis
var ZERO = [0,0,0]
proto.drawLabel = function(d, scale, angle, offset, color, direction) {
