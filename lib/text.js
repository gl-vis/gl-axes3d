...
proto.drawTicks = function(d, scale, angle, offset, color, axis, alignment) {
  if(!this.tickCount[d]) {
    return
  }
  ...
  this.shader.uniforms.alignment = alignment
  this.vao.draw(this.gl.TRIANGLES, this.tickCount[d], this.tickOffset[d])
}

//Draws the text label for an axis
proto.drawLabel = function(d, scale, angle, offset, color, axis, alignment) {
