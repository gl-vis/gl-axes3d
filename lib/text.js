...
proto.drawTicks = function(d, scale, angle, offset, color, axis, alignDir, alignPos, alignOpt) {
  if(!this.tickCount[d]) {
    return
  }
  ...
  this.shader.uniforms.alignPos = alignPos
...
proto.drawLabel = function(d, scale, angle, offset, color, axis, alignDir, alignPos, alignOpt) {
